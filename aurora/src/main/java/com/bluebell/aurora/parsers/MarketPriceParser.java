package com.bluebell.aurora.parsers;
...
public interface MarketPriceParser {
     ...
     */
    default String getLiveDataRoot() {
        return Objects.requireNonNull(getClass().getClassLoader().getResource("sampledata/firstratedata/live")).getFile();
    }
     ...
     * @return sample data path
     */
    default String getSampleDataRoot() {
       return Objects.requireNonNull(getClass().getClassLoader().getResource("sampledata/firstratedata/samples")).getFile();
    }
