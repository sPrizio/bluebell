...
public class ApiExamplesProcessor extends AbstractBluebellProcessor implements BluebellProcessor {
    ...
    private void generateAccountApiExamples() {
        ...
        try {
            ...
            final StandardJsonResponse<List<MarketNewsDTO>> emptyNews = new StandardJsonResponse<>(true, null, "No news for the given date <date>");
            final StandardJsonResponse<MarketNewsDTO> news = new StandardJsonResponse<>(true, null, StringUtils.EMPTY);
            final StandardJsonResponse<List<MarketNewsDTO>> newsList = new StandardJsonResponse<>(true, List.of(), StringUtils.EMPTY);
