...
public class UserApiController extends AbstractApiController {
    ...
    @ApiResponse(
            ...
            content = @Content(
                    ...
                    examples = @ExampleObject(value = ApiErrorExamples.NO_USER_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "200",
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = AccountApiExamples.USER_DTO_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "401",
    ...
    @ApiResponse(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = AccountApiExamples.COUNTRY_CODES_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "401",
    ...
    @ApiResponse(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = AccountApiExamples.PHONE_TYPES_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "401",
    ...
    @ApiResponse(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = AccountApiExamples.CURRENCY_CODES_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "401",
    ...
    @ApiResponse(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = AccountApiExamples.COUNTRIES_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "401",
    ...
    @ApiResponse(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = AccountApiExamples.LANGUAGES_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "401",
    ...
    @ApiResponse(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = AccountApiExamples.TRANSACTIONS_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "401",
