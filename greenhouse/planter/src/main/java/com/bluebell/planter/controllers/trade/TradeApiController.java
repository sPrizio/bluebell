...
public class TradeApiController extends AbstractApiController {
    ...
    @ApiResponse(
            ...
            content = @Content(
                    ...
                    examples = @ExampleObject(value = ApiErrorExamples.BAD_TRADE_TYPE_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "200",
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = ApiErrorExamples.NO_TRADES_FOR_TYPE_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "200",
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = AccountApiExamples.TRADES_DTO_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "401",
    ...
    @ApiResponse(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = ApiErrorExamples.NO_TRADES_FOR_INTERVAL_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "200",
    ...
    @ApiResponse(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = AccountApiExamples.PAGINATED_TRADES_DTO_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "401",
    ...
    @ApiResponse(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = ApiErrorExamples.BAD_TRADE_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "200",
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = AccountApiExamples.TRADE_DTO_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "401",
    ...
    @ApiResponse(
            ...
            content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = StandardJsonResponse.class),
                    examples = @ExampleObject(value = ApiErrorExamples.BAD_FILE_FORMAT_EXAMPLE)
            )
    )
    @ApiResponse(
            responseCode = "200",
