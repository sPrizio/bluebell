...
public class AuroraBorealis implements Strategy<BasicStrategyParameters> {
    ...
    @Override
    public StrategyResult<BasicStrategyParameters> executeStrategy(final LocalDate startDate, final LocalDate endDate, final Map<LocalDate, AggregatedMarketPrices> prices) {
