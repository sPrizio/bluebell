  ...
  return (
    <div className={'min-h-[75vh] flex items-center'}>
      <div className={'grid grid-cols-2 gap-6 items-center'}>
        <div className={''}>
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 600" className="w-full">
            <g>
              <defs>
        ...
        <div className={''}>
          ...
          <div className={'text-2xl font-semibold pb-3 text-black'}>Hello little wanderer!</div>
          <div className={'pb-3 text-black'}>
            The page you are looking for does not exist. How you got here is a mystery. But you can click the button below to go back to your dashboard.
          </div>
          <Link href={'/dashboard'}>
