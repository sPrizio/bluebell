...
export const metadata: Metadata = {
  title: "bluebell",
  description: "bluebell Capital is a software system designed to help track a trader's progress as they navigate the wonderfully tumultuous environment that is the stock market. " +
