                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className={"text-center"}>
                          {rec.report.tradeRecordTotals.trades}
                        </TableCell>
                        <TableCell className={"text-center"}>
                          {rec.report.tradeRecordTotals.winPercentage}%
                        </TableCell>
                        <TableCell className={"text-center"}>
                          {formatNegativePoints(
                            rec.report.tradeRecordTotals.netPoints,
                          )}
                        </TableCell>
                        <TableCell className="text-right">
                          $&nbsp;
                          {formatNumberForDisplay(
                            rec.report.tradeRecordTotals.netProfit,
                          )}
                        </TableCell>
                      </TableRow>
                    );
